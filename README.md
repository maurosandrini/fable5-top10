...
|---|----------|--------|------|
| 1 | open-design: local-first open-source Claude Design with 259+ skills | GitHub | [repo](https://github.com/nexu-io/open-design) |
...
| 3 | codegraph: pre-indexed code knowledge graph for Claude Code and 10+ other runtimes | GitHub | [repo](https://github.com/colbymchenry/codegraph) |
